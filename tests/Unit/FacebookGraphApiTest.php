<?php
    ...
    class FacebookGraphApiTest extends TestCase
    {
         ...
         * @throws Exception
         */
        public function testGetInstagramMediaInsightsPrefiltersUnsupportedFeedImageMetrics(): void
        {
            $responseData = [
                'data' => [
            ...
            $client->getInstagramMediaInsights(
                ...
                customMetrics: ['likes', 'navigation', 'video_views', 'ig_reels_avg_watch_time', 'ig_reels_video_view_total_time'],
                mediaData: ['media_product_type' => 'FEED', 'media_type' => 'IMAGE']
            );

            $lastRequest = $mock->getLastRequest();
            $this->assertStringContainsString('metric=likes', (string)$lastRequest->getUri());
            $this->assertStringNotContainsString('navigation', (string)$lastRequest->getUri());
            $this->assertStringNotContainsString('video_views', (string)$lastRequest->getUri());
            $this->assertStringNotContainsString('ig_reels_avg_watch_time', (string)$lastRequest->getUri());
            $this->assertStringNotContainsString('ig_reels_video_view_total_time', (string)$lastRequest->getUri());
        }
         ...
         * @throws Exception
         */
        public function testGetInstagramMediaInsightsFeedVideoKeepsVideoViews(): void
        {
            $responseData = [
                'data' => [
                    ['name' => 'video_views', 'period' => 'lifetime', 'values' => [['value' => 25]]],
                ],
            ];
            $mock = new MockHandler([
                new Response(200, [], json_encode($responseData)),
            ...
            $client->getInstagramMediaInsights(
                ...
                mediaType: MediaProductType::FEED,
                metricSet: MetricSet::CUSTOM,
                customMetrics: ['likes', 'navigation', 'video_views', 'ig_reels_avg_watch_time'],
                mediaData: ['media_product_type' => 'FEED', 'media_type' => 'VIDEO']
            );

            $lastRequest = $mock->getLastRequest();
            $this->assertStringContainsString(urlencode('likes,video_views'), (string)$lastRequest->getUri());
            $this->assertStringNotContainsString('navigation', (string)$lastRequest->getUri());
            $this->assertStringNotContainsString('ig_reels_avg_watch_time', (string)$lastRequest->getUri());
        }
         ...
         * @throws Exception
         */
        public function testGetInstagramMediaInsightsUnknownMediaTypeUsesDefaultExclusions(): void
        {
            $responseData = [
                'data' => [
            ...
            $client->getInstagramMediaInsights(
                ...
                metricSet: MetricSet::CUSTOM,
                customMetrics: ['likes', 'navigation', 'video_views', 'ig_reels_avg_watch_time'],
                mediaData: ['media_product_type' => 'BROADCAST', 'media_type' => 'LIVE']
            );
